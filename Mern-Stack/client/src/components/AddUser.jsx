...
const AddUser = () => {
    ...
    const { name, username, email, phone, Gender,Country,Salary,Department,Location} = user;
    ...
    return (
        <Container>
            ...
            <FormControl>
                <InputLabel htmlFor="my-input">Salery</InputLabel>
                <Input onChange={(e) => onValueChange(e)} name='salery' value={alery} id="my-input" />
            </FormControl>
            <FormControl>
